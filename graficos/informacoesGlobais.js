...
async function vizualizarInformacoesGlobais() {
    ...
    span>${pessoasEstudando} bilhões</span> estão estudando e passam  em média <span>${horas} horas</span> estudando.<br>Isso significa que aproximadamente <span>${porcentagemEstudando}%</span> de pessoas estão matriculadas em alguma ecola.`
